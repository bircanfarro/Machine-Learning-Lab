...
df_orders$Profit1 = as.numeric(gsub("\\$", "", df_orders$Profit))
df_orders$Profit1
#summary(df_orders) 
#summary(df_orders)
#str(df_orders)
#str(df_orders)
=======
wpath = ".\data\Orders.csv"
mpath = "./data/Orders.csv"
df_orders <- read.csv(mpath, stringsAsFactors = F)
df_returns <- read.csv(mpath, stringsAsFactors = F)

df_orders$Profit = as.numeric(orders$Profit)
df_orders$Sales = as.numeric(orders$Sales)
>>>>>>> cf4bf52e7c2b5d9b10acb3430cc8f72c1a12f5d9
